<template>
  <div class="step-basic q-pa-md anim-fade">
    ...
    <div class="q-col-gutter-y-lg">
      <ProfilePhoto
        :model-value="form.photos"
        label="본인을 표현하는 사진을 등록해주세요"
        required
        @update:model-value="updateField('photos', $event)"
      />
...
import ProfilePhoto from 'src/components/profile/ProfilePhoto.vue';
import {
  BODY_SHAPE_OPTIONS,
  EDUCATION_OPTIONS,
