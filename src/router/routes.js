const routes = [
  {
    ...
    children: [
      ...
      { path: 'self-introduce', component: () => import('pages/self-introduce/SelfIntroducePage.vue') },
      { path: 'self-introduce/new', component: () => import('pages/self-introduce/SelfIntroduceEdit.vue') },
      { path: 'self-introduce/:id/edit', component: () => import('pages/self-introduce/SelfIntroduceEdit.vue') },
      { path: 'self-introduce/:id', component: () => import('pages/self-introduce/SelfIntroduceDetail.vue') },
